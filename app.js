...
const jobTtleContainers = document.querySelector(".jobTtleContainer")
...
//spells "find me" on web app.
//F= 0,1,2,3,41,42,43,42...288
//Then I starts from 5,6,...
	const list = [
...
window.addEventListener("scroll", ()=>{
	...
	jobTitleContainers.style.backgroundPositionX = `${offsetY * 0.5}px`
	jobTtleContainers.style.backgroundPositionY = `${-offsetY * 0.7}px`
	jobTitles[0].style.transform = `translateX(calc(200vh - ${offsetY}px))`
	jobTitles[1].style.transform = `translateX(calc(300vh - ${offsetY}px))` 
	// projectsTitle.style.transform = `translateX(calc(410vh - ${offsetY}px))`
